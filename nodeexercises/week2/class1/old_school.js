...
// call module routine with no error and an // anonymous callback function with 2 params
...
// pass an err argument and see what happens someParam = "err"; // same call as above
someRtnUsingOldSchoolCallback(someParam, (errorMessage, results) => {
...
// if don't pass a callback, an exception occurs // so we need to catch it or the program stops
try {
